...
$sql = "
    ...
    LEFT JOIN paiement_enseignant p ON a.id = p.id_administrateur 
        AND p.mois = :mois 
        AND p.annee = :annee
    WHERE (a.role = 'enseignant_primaire')
";
...
$titre = "Liste des Enseignants primaires";
...
<head>
    ...
    <link rel="stylesheet" href="paiement-enseignant.css">
    <title>Paiement-Enseignant primaire</title>
</head>
<body>
    <div class="container mt-4">
    <form method="GET" action="paiement-enseignant.php">
            <div class="row mb-3">                            
                <div class="col-md-6">
    ...
    <script src="paiement-enseignant.js"></script>
</body>
</html>
