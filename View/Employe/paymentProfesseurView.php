...
<div class="dashboard">
	...
	<main class="content-wrap">
        ...
        require_once __DIR__ . '/../../Model/payementProfesseurmodel.php';
        require_once __DIR__ . '/../../Controlleur/paymentProfesseurController.php';

        // Créer une instance du contrôleur
        $controller = new PaymentProfController($pdo);
        $surveillants = $controller->getAll(); // Récupérez les profs
        ...
        <div class="container-fluid h-100 bg-light">
            <h1 class="text-dark">Liste des Professeurs Secondaires</h1>
    ...
    <div class="container mt-3">
        ...
        <div class="row mb-3">
            <div class="d-flex flex-wrap">
                <div class="me-4 mb-2">
                    <a href="#" class="list-group-item list-group-item-action" data-month="1" onclick="selectMonth(this)">Janvier</a>
                </div>
                <div class="me-4 mb-2">
                    <a href="#" class="list-group-item list-group-item-action" data-month="2" onclick="selectMonth(this)">Février</a>
                </div>
                <div class="me-4 mb-2">
                    <a href="#" class="list-group-item list-group-item-action" data-month="3" onclick="selectMonth(this)">Mars</a>
                </div>
                <div class="me-4 mb-2">
                    <a href="#" class="list-group-item list-group-item-action" data-month="4" onclick="selectMonth(this)">Avril</a>
                </div>
                <div class="me-4 mb-2">
                    <a href="#" class="list-group-item list-group-item-action" data-month="5" onclick="selectMonth(this)">Mai</a>
                </div>
                <div class="me-4 mb-2">
                    <a href="#" class="list-group-item list-group-item-action" data-month="6" onclick="selectMonth(this)">Juin</a>
                </div>
                <div class="me-4 mb-2">
                    <a href="#" class="list-group-item list-group-item-action" data-month="7" onclick="selectMonth(this)">Juillet</a>
                </div>
                <div class="me-4 mb-2">
                    <a href="#" class="list-group-item list-group-item-action" data-month="8" onclick="selectMonth(this)">Août</a>
                </div>
                <div class="me-4 mb-2">
                    <a href="#" class="list-group-item list-group-item-action" data-month="9" onclick="selectMonth(this)">Septembre</a>
                </div>
                <div class="me-4 mb-2">
                    <a href="#" class="list-group-item list-group-item-action" data-month="10" onclick="selectMonth(this)">Octobre</a>
                </div>
                <div class="me-4 mb-2">
                    <a href="#" class="list-group-item list-group-item-action" data-month="11" onclick="selectMonth(this)">Novembre</a>
                </div>
                <div class="me-4 mb-2">
                    <a href="#" class="list-group-item list-group-item-action" data-month="12" onclick="selectMonth(this)">Décembre</a>
                </div>
            </div>
        </div>
        
        <!-- Champ caché pour stocker le mois sélectionné -->
        <input type="hidden" id="mois" name="mois" value="" required>
    </div>
</div>
